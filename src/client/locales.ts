...
const zh = {
  ...
  'scm.untracked': '未跟踪',
  'scm.commit.placeholder': '提交变更内容(Ctrl+Enter 在',
  'scm.commit.button': '✓ 提交 Ctrl+Enter',
...
const en: Record<SolutionExplorerKey, string> = {
  ...
  'scm.commit.placeholder': 'Commit changes (Ctrl+Enter on',
  'scm.commit.button': '✓ Commit Ctrl+Enter',
